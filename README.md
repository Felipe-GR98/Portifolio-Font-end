...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/seu-usuario/Portifolio-Font-end.git
   ```

2. Acesse a pasta do projeto:

   ```bash
   cd Portifolio-Font-end
   ```
...
🔗 [https://seu-usuario.github.io/seu-repositorio](https://felipe-gr98.github.io/Portifolio-Font-end/)
